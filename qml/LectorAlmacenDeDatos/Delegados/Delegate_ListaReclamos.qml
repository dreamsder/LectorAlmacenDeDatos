...
Rectangle{
    ...
    property string modoDeCargarReclamos: modoCargaReclamos
    ...
    Rectangle {
        ...
        width: {
            ...
            if(rectPrincipal.width<1300){
                220+(rectPrincipal.width-1024)
            }else{
    ...
    ListView {
        ...
        anchors.left: parent.left
        anchors.leftMargin: 0
        delegate: Delegate_ListaReclamosControl{
        }
        model: modeloListaDeReclamosControl
    }
    ListModel{
        id:modeloListaDeReclamosControl
    }*/
